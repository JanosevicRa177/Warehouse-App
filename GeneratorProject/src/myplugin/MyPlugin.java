...
public class MyPlugin extends com.nomagic.magicdraw.plugins.Plugin {
	...
	private void modelOptions() {
		GeneratorOptions generatorOptions = new GeneratorOptions(path +"BackendProject/BackendProject", "entity",
	...
	private void enumOptions() {
		GeneratorOptions generatorOptions = new GeneratorOptions(path +"BackendProject/BackendProject/Model/",
	...
	private void dbContextOptions() {
		GeneratorOptions generatorOptions = new GeneratorOptions(
				path +"BackendProject/BackendProject/Infrastructure/", "dbContext", "templates", "{0}.cs", true,
				"BackendProject");
	...
	private void repositoryOptions() {
		GeneratorOptions generatorOptions = new GeneratorOptions(
				path +"BackendProject/BackendProject/Infrastructure/", "repository", "templates", "{0}.cs", true,
				"BackendProject");
	...
	private void repositoryInterfaceOptions() {
		GeneratorOptions generatorOptions = new GeneratorOptions(
				path +"BackendProject/BackendProject/Infrastructure/", "repositoryInterface", "templates", "{0}.cs",
				true, "BackendProject");
	...
	private void appCssOptions() {
		GeneratorOptions generatorOptions = new GeneratorOptions(path +"FrontendProject/FrontendProject/src/app", "appCss", "templates", "{0}.css", true, "FrontendProject");
	...
	private void crudCommandOptions() {
		GeneratorOptions generatorOptions = new GeneratorOptions(path +"BackendProject/BackendProject/Application/",
	...
	private void componentOptions() {
		GeneratorOptions generatorOptions = new GeneratorOptions(path +"FrontendProject/FrontendProject/src/app/components", "component", "templates", "{0}.ts", true, "FrontendProject");
		ProjectOptions.getProjectOptions().getGeneratorOptions().put("ComponentGenerator", generatorOptions);
		generatorOptions.setTemplateDir(pluginDir + File.separator + generatorOptions.getTemplateDir());
    }
	
	private void routingOptions() {
		GeneratorOptions generatorOptions = new GeneratorOptions(path +"FrontendProject/FrontendProject/src/app", "routing", "templates", "{0}.ts", true, "FrontendProject");
		ProjectOptions.getProjectOptions().getGeneratorOptions().put("RoutingGenerator", generatorOptions);
		generatorOptions.setTemplateDir(pluginDir + File.separator + generatorOptions.getTemplateDir());
	}

	private void htmlOptions() {
		GeneratorOptions generatorOptions = new GeneratorOptions(path +"FrontendProject/FrontendProject/src/app/components", "html", "templates", "{0}.html", true, "FrontendProject");
		ProjectOptions.getProjectOptions().getGeneratorOptions().put("HtmlGenerator", generatorOptions);
		generatorOptions.setTemplateDir(pluginDir + File.separator + generatorOptions.getTemplateDir());
	}
	
	private void cssOptions() {
		GeneratorOptions generatorOptions = new GeneratorOptions(path +"FrontendProject/FrontendProject/src/app/components", "css", "templates", "{0}.css", true, "FrontendProject");
	...
	private void appModuleOptions() {
		GeneratorOptions generatorOptions = new GeneratorOptions(path +"FrontendProject/FrontendProject/src/app",
	...
	private void serviceOptions() {
		GeneratorOptions generatorOptions = new GeneratorOptions(
				path +"FrontendProject/FrontendProject/src/app/services", "service", "templates", "{0}.ts", true,
				"FrontendProject");
